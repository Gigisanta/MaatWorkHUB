...
export function LinkProjectForm({ tenantId, initialGithub, initialVercelId, initialVercelUrl }: LinkProjectFormProps) {
    ...
    <Card className="border-white/5 bg-black/40 backdrop-blur-3xl">
      ...
      <CardContent className="space-y-4">
        ...
        <Button 
          ...
          onClick={() => execute({ tenantId, githubRepo: github, vercelProjectId: vercelId, vercelUrl })}
